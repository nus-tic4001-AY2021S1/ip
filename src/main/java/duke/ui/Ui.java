...
public class Ui {
    ...
    public void printGreeting() {
        String greeting = "Hello! I'm Duke.\n"
                ...
                + "  ⬢  Mark a task as completed | " + colorGreen("done <task index number>\n")
    ...
    public void printTaskAdded(String line, TaskList tasks) {
    ...
    public void printTaskDone(int index, TaskList tasks) {
    ...
    public String colorGreen(String input) { return "\033[33m" + input + "\033[0m"; }
}

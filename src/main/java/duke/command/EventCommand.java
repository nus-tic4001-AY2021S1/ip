...
/**
 * A command to create a Event task.
 */
public class EventCommand extends Command {
    ...
    public EventCommand(String line, Ui ui, Storage storage, ArrayList commandName) {
    ...
    public String execute() {
        ...
        commandName.add(new duke.tasks.Event(description, date, email));
